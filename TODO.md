...
- [ ] Connect the repo to Cloudflare Pages git integration (dashboard →
      Workers & Pages → Create → Pages → Import Git repository) AFTER the
      push; the old direct-upload project must be deleted first ([0005](docs/decisions/0005-deploy-via-cloudflare-git-integration.md)).
